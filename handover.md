...
- **Config + persistence**: `config.Manager` reads/writes JSON in the user config dir; defaults align with current tuning (template 30px, sensitivity 30, etc.). Save/Update calls from the UI immediately apply and persist parameters.
